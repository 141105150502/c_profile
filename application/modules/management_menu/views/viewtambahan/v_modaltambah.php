       ...
       <form id="formaddmenu" enctype="multipart/form-data">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" placeholder="Nama Menu" name="nama_menu" class="form-control" id="nama_menu">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" placeholder="url" name="url" class="form-control" id="url">
            </div>
          </div>
    	...
    	<div class="modal-footer">
      	...
      	<button type="button" class="btn btn-primary" onclick="simpanmenu()">Simpan</button>
    	</div>