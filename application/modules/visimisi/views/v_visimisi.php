						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<button onclick="editmodal(<?php echo $vismis->id_profileperusahaan ?>)" class="btn btn-primary mb-3">Edit Visi Misi </button>
                                    <table class="table">
                                        <tr>
                                            <th>
                                              <?php echo $vismis->visimisi_perusahaan ?>
                                            </th>
                                        </tr>
                                    </table>
...
<script type="text/javascript">
    ...
    function editvisimisi(){
        const isi = visimisi.getData();



    	$.ajax({
    		url:'<?php echo base_url() ?><?php echo $this->uri->segment(1) ?>/editvisimisi',
    		type:'post',
    		data:{
                  'visimisi':isi,
