...
function customCheckColor(){
	...
	if (logoHeader !== "white") {
		...
		$('.logo-header .navbar-brand').attr('src', 'http://localhost/core_ku/assets/img/logo.svg');
	} else {
		// $('.logo-header .navbar-brand').attr('src', '../assets/img/logo2.svg');
		$('.logo-header .navbar-brand').attr('src', 'http://localhost/core_ku/assets/img/logo2.svg');
	}
}
